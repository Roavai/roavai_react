...
function Footer() {
    return (
        <>
            ...
            <footer class="bg-neutral-primary-soft  bg-black text-gray-300 ">
                <div class="mx-auto w-full max-w-7xl p-4 py-6 lg:py-8">
                    <div class="md:flex md:justify-between">
                        <div class="mb-6 md:mb-0">
                            <a href="#" class="flex items-center">
                                <img src={ROAVAI} class="h-20 w-20" alt="Roavai with pet Logo" />
                    ...
                    <div class="sm:flex sm:items-center sm:justify-between">
                        <span class="text-sm text-body sm:text-center">© 2024 <a href="https://roavai.com/" class="hover:underline">Roavai</a>. All Rights Reserved.
                        </span>
