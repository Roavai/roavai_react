                ...
                <div className="mx-auto w-full max-w-7xl p-4 py-6 lg:py-8">
                        ...
                        <div className="nav-link-font grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                            ...
                            <div>
                                ...
                                <ul className="text-body text-md font-small">
                                    ...
                                    <li className="mb-4">
                                        <a href="https://www.linkedin.com/in/roavai-pvt-ltd-a48754391?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app" target="_blank" rel="noopener noreferrer" className="nav-link-cursor">Linkedin</a>
                                    </li>
                                </ul>
                            </div>
                            <div>
                    ...
                    <div className="sm:flex sm:items-center sm:justify-between">
                        ...
                        <div className="flex mt-4 sm:justify-center sm:mt-0">
                            ...
                            <a href="https://www.linkedin.com/in/roavai-pvt-ltd-a48754391?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app" target="_blank" rel="noopener noreferrer" className="text-body hover:text-heading ms-5">
