            ...
            <footer className="bg-neutral-primary-soft  bg-black text-gray-300 ">
                <div className="mx-auto w-full max-w-7xl p-4 py-6 lg:py-8">
                    <div className="md:flex md:justify-between">
                        <div className="mb-6 md:mb-0">
                            <a href="#" className="flex items-center">
                                <img src={ROAVAI} className="h-25 w-25" alt="Roavai with pet Logo" />
                    ...
                    <div className="sm:flex sm:items-center sm:justify-between">
                        <span className="text-sm text-body sm:text-center">© 2024 <a href="https://roavai.com/" className="hover:underline">Roavai</a>. All Rights Reserved.
                        </span>
