...
export default function CloudTutorOverview() {
    ...
    return (
        <section className="relative min-h-screen md:h-screen pt-20 md:pt-24 pb-12 md:pb-8 overflow-x-hidden md:overflow-hidden bg-[#fff7c5] text-black flex flex-col justify-center items-center px-4 sm:px-12 md:px-16 lg:px-24">
