...
function Navbar() {
    ...
    return (
        <>
            <header className="fixed inset-x-0 top-0 z-40 bg-[linear-gradient(to_bottom,rgba(10,10,10,0.15)_0%,rgba(10,10,10,0.2)_100%)] backdrop-blur-xs">
                <div className="relative flex h-14 items-center px-4 md:px-8">
                    <span className="nav-link-cursor text-2xl font-logo tracking-[0.35em]">
                        <a
                            className="text-2xl md:text-3xl z-50 tracking-[0.1em]"
